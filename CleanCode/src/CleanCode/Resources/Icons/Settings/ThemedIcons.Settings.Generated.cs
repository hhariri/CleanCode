...
namespace CleanCode.Resources.Icons
{
	...
	///  <para>To use an icon from XAML, set an <see cref="System.Windows.Media.ImageSource" /> property to the <see cref="JetBrains.UI.Icons.ThemedIconExtension" /> markup extension, which takes an icon identifier class (nested in <see cref="CleanCode.Resources.Icons.SettingsThemedIcons" /> class) as a parameter.</para>
	///  <para>Example:</para>
	///  <code>&lt;Image Source="{icons:ThemedIcon myres:SettingsThemedIcons+CleanCode}" /&gt;</code>
	///  <h1>Attributes</h1>
	///  <para>Sometimes you have to reference an icon from a type attriute when you're defining objects in code. Typical examples are Options pages and Tool Windows.</para>
	///  <para>To avoid the use of string IDs which are not validated very well, we've emitted identifier classes to be used with <c>typeof()</c> expression, one per each icon. Use the attribute overload which takes a <see cref="System.Type" /> for an image, and choose your icon class from nested classes in the <see cref="CleanCode.Resources.Icons.SettingsThemedIcons" /> class.</para>
	///  <para>Example:</para>
	///  <code>[Item(Name="Sample", Icon=typeof(SettingsThemedIcons.CleanCode))]</code>
	///  <h1>CodeBehind</h1>
	///  <para>In codebehind, we have two distinct tasks: (a) specify some icon in the APIs and (b) render icon images onscreen.</para>
	///  <para>On the APIs stage you should only manipulate icon identifier objects (of type <see cref="JetBrains.UI.Icons.IconId" />, statically defined in <see cref="CleanCode.Resources.Icons.SettingsThemedIcons" /> in <c>Id</c> fields). Icon identifier classes (nested in <see cref="CleanCode.Resources.Icons.SettingsThemedIcons" />) should be turned into icon identifier objects as early as possible. Rendering is about getting an <see cref="System.Windows.Media.ImageSource" /> to assign to WPF, or <see cref="System.Drawing.Bitmap" /> to use with GDI+ / Windows Forms.</para>
	...
	public sealed class SettingsThemedIcons
	{
		...
		///    <para>Identifier classes should be used in attributes, XAML, or generic parameters. Where an <see cref="JetBrains.UI.Icons.IconId" /> value is expected, use the identifier object in the <see cref="CleanCode.Resources.Icons.SettingsThemedIcons.CleanCode.Id" /> field of the identifier class.</para>
		///  </para>
		///</summary>
		///<remarks>
		///  <para>For details on Themed Icons and their use, see Remarks on <see cref="CleanCode.Resources.Icons.SettingsThemedIcons" /> class.</para>
		///</remarks>
		///<seealso cref="CleanCode.Resources.Icons.SettingsThemedIcons" />
		///<example>
		...
		public sealed class CleanCode : global::JetBrains.UI.Icons.CompiledIcons.CompiledIconClass
		{
			...
			///    <para>Identifier objects should be used where an <see cref="JetBrains.UI.Icons.IconId" /> value is expected. In attributes, XAML, or generic parameters use the containing <see cref="CleanCode.Resources.Icons.SettingsThemedIcons.CleanCode" /> identifier class.</para>
			///  </para>
			///</summary>
			///<remarks>
			///  <para>For details on Themed Icons and their use, see Remarks on <see cref="CleanCode.Resources.Icons.SettingsThemedIcons" /> class.</para>
...
public sealed class RenderedIcons_ByPackResourceNameHash_E1185BB5DC155E8A999AD43CA329D4ED
{
	...
	public static byte[] CleanCode____png__x2 = new byte[] {
			137,
			80,
			78,
			71,
